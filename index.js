...
function init() {
    ...
    .prompt([
     ...
     {
      type: 'input',         
      message: 'Please enter a working link for the demo video, or use the relative path in your app folder:',      
      name: 'video', 
     },
     {
      type: 'input',         
      message: 'Please enter a working link for a screenshot of the demo video, or use the relative path in your app folder:',      
      name: 'screenshot', 
     },
     {
      type: 'input',         
